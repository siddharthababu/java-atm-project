...
import com.codegnan.atmproject.OperatorCard;
...
public class ATMOperations {
	...
	public static void validateAmount(double amount)
			throws InsufficientBalanceException, InsufficientMachineBalnaceException {
		if (amount > ATM_MACHINE_BALANCE) {
			throw new InsufficientMachineBalnaceException("Insufficient cash in the Machine");
		}
	}

	// Validate deposit amount to ensure it meets machine requirements
	public static void validateDepositAmount(double amount)
			throws InsufficientMachineBalnaceException, InvalidAmountException {
		...
		if (amount + ATM_MACHINE_BALANCE > 200000.0d) {
			...
			throw new InsufficientMachineBalnaceException(
		...
		while (flag) {
			...
			case 2:
				...
				try {
					...
					System.out.println("==================================================================");
				} catch (InvalidAmountException | InsufficientMachineBalnaceException e) {
	...
	public static void main(String[] args) throws NotAOperatorException {
		...
		dataBase.put(2222222221L, new AxisDebitCard(222222221L, "Akash", 50000.0, 2222));
		dataBase.put(3333333331L, new SBIDebitCard(3333333331L, "Akhil", 55000.0, 3333));
		dataBase.put(4444444441L, new AxisDebitCard(4444444441L, "Mani", 32500.0, 4444));
		dataBase.put(5555555551L, new HDFCDebitCard(5555555551L, "Ram", 71000.0, 5555));
		dataBase.put(1111111111L, new OperatorCard(1111111111L, 1111, "Operator_1"));
		Scanner scanner = new Scanner(System.in);
		long cardNumber = 0;
				...
				while (true) {
					...
					try {
						...
						if (nextOption.equalsIgnoreCase("N")) {
							...
							| InsufficientMachineBalnaceException e) {
						System.out.println(e.getMessage());
					}
				}
